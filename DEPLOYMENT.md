...
| `UNSPLASH_SECRET_KEY`           | Secret Key from the same app        | **Secret** (P6.0 — unused by any code today, only needed for Unsplash OAuth user actions this app doesn't do; kept server-only regardless)          |
