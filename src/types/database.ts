...
export type Database = {
  public: {
    Tables: {
      ...
      profiles: {
        Row: {
          achievements_evaluated_at: string | null;
          active_goal_limit: number;
          auto_share_profile: boolean;
          auto_share_someday: boolean;
          avatar: Json;
          base_currency: string;
          check_in_day: number;
          created_at: string;
      ...
      someday_items: {
        Row: {
          ...
          id: string;
          image_source:
            Database["public"]["Enums"]["dream_image_source"] | null;
    ...
    Views: {
      ...
      v_available_presets: {
        Row: {
          ...
          unlock_achievement_id: string | null;
          unlock_achievement_name: string | null;
      ...
      v_shared_with_me_all: {
        Row: {
          grant_id: string | null;
          owner_avatar: Json | null;
          owner_handle: string | null;
          owner_id: string | null;
    ...
    Functions: {
      ...
      send_friend_request: { Args: { p_handle: string }; Returns: string };
      share_resource: {
        Args: {
          p_grantee: string;
      ...
      unfriend: { Args: { p_user: string }; Returns: undefined };
      unshare_resource: {
        Args: {
          p_grantee: string;
          p_resource_id: string;
